...
class Config:
    ...
    max_depth: float = 30.  # maximum sampled distance
    batch_size: int = 8  # number of images to process at once
    num_workers: int = 4  # number of parallel workers to use for data loading
    ...
    make_figures: bool = False  # save figures in results directory
